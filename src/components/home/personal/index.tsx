        ...
        <div className="px-10 sm:px-20 lg:px-40 2xl:px-80 pb-4">
          <div className="2xl:pl-64">
            <a
              ...
              <h2 className="w-full sm:text-xl">ponzaceniow</h2>
            </a>
            <a
              ...
              <h2 className="w-full sm:text-xl">ponzacenio.work@gmail.com</h2>
            </a>
            <a
              href="tel:5574963573"
              className="grid grid-cols-2-iauto gap-4 items-center hover:bg-gradient-to-r from-gray-900/70 to-gray-800/10 p-2 rounded-full hover:text-center">
              <PhoneIcon className="stroke-amber-200/80 stroke-[1.5rem] w-8" />
              <h2 className="w-full sm:text-xl">(+52) 55-7496-3573</h2>
            </a>
            <a
              ...
              <h2 className="w-full sm:text-xl">
                Salvador Díaz Mirón 161, Sta. María la Ribera, Cuauhtémoc,
                06400, CDMX
              </h2>
            </a>
          </div>
